...
describe('v2.BareMetalSolutionClient', () => {
    ...
    describe('getVolume', () => {
        it('invokes getVolume without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetVolumeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listNetworkUsage', () => {
        it('invokes listNetworkUsage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListNetworkUsageRequest', ['location']);
    ...
    describe('getNetwork', () => {
        it('invokes getNetwork without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetNetworkRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getLun', () => {
        it('invokes getLun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetLunRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getNfsShare', () => {
        it('invokes getNfsShare without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetNfsShareRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('resetInstance', () => {
        it('invokes resetInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ResetInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('startInstance', () => {
        it('invokes startInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StartInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('stopInstance', () => {
        it('invokes stopInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StopInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('detachLun', () => {
        it('invokes detachLun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DetachLunRequest', ['instance']);
    ...
    describe('updateVolume', () => {
        it('invokes updateVolume without error', async () => {
            ...
            request.volume ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateVolumeRequest', ['volume', 'name']);
    ...
    describe('resizeVolume', () => {
        it('invokes resizeVolume without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ResizeVolumeRequest', ['volume']);
    ...
    describe('updateNetwork', () => {
        it('invokes updateNetwork without error', async () => {
            ...
            request.network ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateNetworkRequest', ['network', 'name']);
    ...
    describe('updateNfsShare', () => {
        it('invokes updateNfsShare without error', async () => {
            ...
            request.nfsShare ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateNfsShareRequest', ['nfsShare', 'name']);
    ...
    describe('listVolumes', () => {
        it('invokes listVolumes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListVolumesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listNetworks', () => {
        it('invokes listNetworks without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListNetworksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listLuns', () => {
        it('invokes listLuns without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListLunsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listNfsShares', () => {
        it('invokes listNfsShares without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListNfsSharesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
