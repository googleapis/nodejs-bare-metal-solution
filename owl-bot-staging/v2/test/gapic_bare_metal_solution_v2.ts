...
describe('v2.BareMetalSolutionClient', () => {
    ...
    describe('listNetworkUsage', () => {
        it('invokes listNetworkUsage without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.ListNetworkUsageRequest());
            request.location = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.ListNetworkUsageResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listNetworkUsage as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getNfsShare', () => {
        it('invokes getNfsShare without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.GetNfsShareRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.NfsShare());
            client.innerApiCalls.getNfsShare = stubSimpleCall(expectedResponse);
            const [response] = await client.getNfsShare(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getNfsShare as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateInstance', () => {
        it('invokes updateInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.UpdateInstanceRequest());
            request.instance = {};
    ...
    describe('startInstance', () => {
        it('invokes startInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.StartInstanceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('stopInstance', () => {
        it('invokes stopInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.StopInstanceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('detachLun', () => {
        it('invokes detachLun without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.DetachLunRequest());
            request.instance = '';
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.detachLun as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('resizeVolume', () => {
        it('invokes resizeVolume without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.ResizeVolumeRequest());
            request.volume = '';
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.resizeVolume as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateNetwork', () => {
        it('invokes updateNetwork without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.UpdateNetworkRequest());
            request.network = {};
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateNetwork as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateNfsShare', () => {
        it('invokes updateNfsShare without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.UpdateNfsShareRequest());
            request.nfsShare = {};
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateNfsShare as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listNfsShares', () => {
        it('invokes listNfsShares without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.baremetalsolution.v2.ListNfsSharesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listNfsShares as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
